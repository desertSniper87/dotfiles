...
c.url.searchengines = {\
        'DEFAULT': 'https://www.google.com/search?q={}&ie=utf-8&oe=utf-8',\
        'pyd': 'file:///home/torsho/Downloads/python-3.6.3rc1-docs-html/search.html?q={}',\
        'yandex': 'https://yandex.com/search/?&text={}',\
        'rarbg': 'http://rarbg.to/torrents.php?search={}&order=seeders&by=DESC',\
        'tpb': 'https://thepiratebay.org/s/?q={}&category=0&page=0&orderby=99',\
...
config.bind(',o', '''  jseval var jsCode = document.createElement('script'); jsCode.setAttribute('src', 'https://www.onenote.com/Clipper/Root?ClipperId=ON-95a88c52-50d6-4c35-b134-2bdd4f682242&ClipperType=Bookmarklet&ClipperVersion=2.0.2'); jsCode.setAttribute('id', 'oneNoteCaptureRootScript'); jsCode.setAttribute('type', 'text/javascript'); document.body.appendChild(jsCode);  ''')


config.bind(',i', '''  jseval function()%7Bvar%20u='https://icrumz.com/icrumz/add',d=document,w=window,a=d.getElementsByTagName('LINK'),l=w.location,h=l.href.match(/%5Ehttps?:%5C/%5C/.*?%5C//),e=encodeURIComponent,m=d.getElementsByTagName('META'),n='',k='',t,i,s=''+(w.getSelection?w.getSelection():d.getSelection?d.getSelection():d.selection?d.selection.createRange().text:'');if(m)for(i=0;i%3Cm.length;i++)%7Bif(m%5Bi%5D.name)%7Bt=m%5Bi%5D.name.toLowerCase();if(t=='description')n=m%5Bi%5D.content;if(t=='keywords')k=m%5Bi%5D.content%7D%7Dif(s)n=s;if(h)h=h%5B0%5D+'favicon.ico';else%20h='';for(i=0;i%3Ca.length;i++)%7Bif(a%5Bi%5D.rel&&a%5Bi%5D.rel.match(/%5E(shortcut%20icon%7Cicon)/i)&&a%5Bi%5D.href&&a%5Bi%5D.href.match(/%5Ehttps?:%5C/%5C//))%7Bh=a%5Bi%5D.href%7D%7Dl.href=(u+'?v=1'+'&h='+e(l.href)+'&i='+e(h)+'&t='+e(d.title.substr(0,200))+'&k='+e(k.substr(0,200))+'&d='+e(n)).substring(0,navigator.userAgent.match(/MSIE/)?2080:4000)%7D)()''') 



config.bind(',n' ,'set ui user-stylesheet ~/Documents/solarized-everything-css/css/solarized-all-sites-dark.css "" ;; reload')
